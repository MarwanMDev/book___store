...
// import { ShareElectronicBookModule } from 'src/app/share-electronic-book/share-electronic-book.module';
...
export class AllElectronicBooksComponent implements OnInit {
  ...
  constructor( private _AuthService:AuthService ,private _AddNewBookService : AddNewBookService , private _AddCatService:AddCatService){}
