...
export class HomePanelComponent implements OnInit {
  ...
  constructor(private _UsersSerService:UsersSerService , private _AuthService : AuthService , private _HomePanelServiceService:HomePanelServiceService
...
// get total price of all orders 
  ...
  checkData_TotalPrice(){
    ...
    if(userToken){
      this._HomePanelServiceService.GetTotalPrice(userToken).subscribe({
        next:(res)=>{
